...
public class S42Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListView listView1=(ListView)findViewById(R.id.lv_baito);
	...
	class ImageButtonClickListener1 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S42Activity.this , S1Activity.class);
	...
	class ButtonClickListener1 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S42Activity.this , S3Activity.class);
		    startActivity(intent);
		}
	}
	...
	class ButtonClickListener2 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S42Activity.this , S2Activity.class);
		    startActivity(intent);
	...
	class ButtonClickListener3 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S42Activity.this , S5Activity.class);
		    startActivity(intent);
	...
	class ButtonClickListener4 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S42Activity.this , Upload.class);
		    startActivity(intent);
	...
	class ListItemClickListener implements OnItemClickListener{
		public void onItemClick(AdapterView<?>parent,View view,int position,long id){
			...
			Intent intent = new Intent(S42Activity.this,ShareImageActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.s42, menu);
		return true;
	}
