...
public class S3Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button button1=(Button)findViewById(R.id.Campuslist_new);
		...
		ListView listView1=(ListView)findViewById(R.id.lv_campus);
	...
	class ImageButtonClickListener1 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S3Activity.this , S1Activity.class);
	...
	class ButtonClickListener1 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S3Activity.this , S32Activity.class);
		    startActivity(intent);
	...
	class ButtonClickListener2 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S3Activity.this , S2Activity.class);
		    startActivity(intent);
		}
	}
	...
	class ButtonClickListener4 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S3Activity.this , S5Activity.class);
		    startActivity(intent);
	...
	class ButtonClickListener5 implements OnClickListener{
		public void onClick(View v){
			Intent intent = new Intent(S3Activity.this , ToukouCampusActivity.class);
		    startActivity(intent);
	...
	class ListItemClickListener implements OnItemClickListener{
		public void onItemClick(AdapterView<?>parent,View view,int position,long id){
			...
			Intent intent = new Intent(S3Activity.this,CampusActivity.class);
